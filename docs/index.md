...
- [Entity Actions](entity-actions.md) explains compiled Entity action registrars and the `entities/<entity>/actions/actions.go` convention.
- [App SDK](sdk.md) explains the Go package app code uses for hooks, Entity actions, Jobs, Record access, and Logs.
